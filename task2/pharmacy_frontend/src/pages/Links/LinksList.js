...
const LinksList = () => {
  ...
  const loadLinks = () => {
    ...
    if (queryParams.isPublished && searchParams.get('isPublished') !== null) {
      endpoint += `&isPublished=${
        searchParams.get('isPublished') == 'Да' ? 1 : 0
      }`;
    } else {
      setQueryParams({
        ...queryParams,
    ...
    if (
      queryParams.isModerationPassed &&
      searchParams.get('isModerationPassed') !== null
    ) {
      endpoint += `&isModerationPassed=${
        searchParams.get('isModerationPassed') == 'Да' ? 1 : 0
      }`;
    } else {
      setQueryParams({
        ...queryParams,
  ...
  return (
    <>
      ...
      <Box className="headerWrapper">
        <Box className="headerTitle">Ссылки</Box>
      </Box>
      <Box
                      ...
                      >
                        ...
                        >
                          ...
                          <Select
                            ...
                            value={queryParams.isModerationPassed}
                            label="На модерации"
                            onChange={handleChangeQueryParams}
                          >
                            <MenuItem value={''}>Все</MenuItem>,
                            <MenuItem value={'Нет'}>Да</MenuItem>
                            <MenuItem value={'Да'}>Нет</MenuItem>
                          </Select>
                        </FormControl>
                        <FormControl
                          fullWidth
